(function($){
	...
	$(document).ready(function() {
		...
		var mapLocation = new google.maps.LatLng(48.6123069,-2.0511951);
		...
		if ($mapis.length > 0) {
			...
			var image = new google.maps.MarkerImage('images/semantic/map-icon.png',
			...
			map.addMarker({
				...
				title: 'Rival',
				infoWindow: {
					content: '<p><strong>Lugand-Delomotte  Architecte</strong><br/>P.A DE L’HERMITAGE - 35780 LA RICHARDAIS<br/>BP 10244 - 35802 DINARD CEDEX<br/><p>'
				}
			});
